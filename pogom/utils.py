...
def send_to_webhook(message_type, message):
    ...
    url = "https://gcm-http.googleapis.com/gcm/send"
                ...
                # }
    APIKEY = "key= AIzaSyBrZASVNSUcT3WKi3DqJO7Lk9OrdhOLp8o"

    namepokemon = get_pokemon_name(message.get("pokemon_id"))
    if(message_type=="pokemon"):
        data = {
            ...
            "registration_ids": ["d6_QY0z9cWc:APA91bEL6ctK3Z9JbtNqRp2Pg6na6RH1CMW5Wbbg2BBX5NyAqAcd0ca1V5PPhNI4NYPKIHSZNDYbBWb94Z6yDu1bWxd-4eyJeBhzcjZ5kl0VAmnS062i8HomDvl1jPlpWdl4avbIR1uQ","catC4JmequY:APA91bHwl16xV78mWv9JgEayd5OOURkULsMLT_5pTaSHZ8uMbXHLz7yjSGCtql_JBbqk32qDdNbhqRnS644noqxyW_u1pbI93EFswwY5AGHtCiC2z4p8FLlb0JnQ2qpzzLKo-PpZn6sg"]
        }
        ...
        headers = {
            ...
            'postman-token': "445c78dd-b950-fd4f-e5bd-db27913e600e"
        }
